...
const { supabaseHeaders } = require('./supabase');

const memoryBuckets = new Map();

function clientIp(req) {
  const forwarded = String(req.headers['x-real-ip'] || req.headers['x-vercel-forwarded-for'] || req.headers['x-forwarded-for'] || req.socket?.remoteAddress || 'unknown');
